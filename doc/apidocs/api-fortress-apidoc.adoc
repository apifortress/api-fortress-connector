...
|======================
|Return Java Type | Description
|+++<a href="javadocs/org/mule/modules/apifortress/responses/TestExecutionResponses.html">TestExecutionResponses</a>+++ | +++A TestExeuctionResponses object, a collection representing all the test execution results for this automatch operation+++
|======================
