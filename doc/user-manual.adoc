...
We strongly suggest you review the Examples, or create a test using link:http://apifortress.com/doc/writing-your-first-test/[Magic] to quickly learn how to use the GUI composer.
