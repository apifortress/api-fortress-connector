...
|*singleTestSynchronous* | The test will run and return the results of the test | hook,testId,headers,variables.
|*singleTestPassthrough* | The test will run and return the received payload | hook,testId,headers,variables.
|*automatchSynchronous* | The test will run and return the results of the test, the "automatch" variable will be used to determine which tests to run | hook,headers,variables.
...
|*testId* | For a single test run, the ID of the test to run.
