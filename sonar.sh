...
mvn clean org.jacoco:jacoco-maven-plugin:prepare-agent install -Dtest="*Test,*TestSuite" -Dmaven.test.failure.ignore=true && mvn sonar:sonar -Dsonar.scm.disabled=true
